...
Output.prototype.current = function () {
    ...
    var c = this.currently,
        ...
        feels = hotCold(Math.round(c.apparentTemperature), this.args.c || this.args.celsius),
        temp = hotCold(Math.round(c.temperature), this.args.c || this.args.celsius),
...
Output.prototype.data = function () {
    ...
    this.daily.forEach(function (day) {
        ...
        temps = chalk.bold(hotCold(Math.round(day.temperatureMax), _this.args.c || _this.args.celsius)) + "° " + chalk.dim(hotCold(Math.round(day.temperatureMin), _this.args.c || _this.args.celsius)) + "°";
