...
function handleArgs(argv, units, ip) {
    ...
    if (argv.h || argv.help){
      console.log('cli-weather, version: %s', pgk.version);
      console.log('--------------------------');
      console.log('available commands:');
      console.log('\t -a, --address \t pass address');
      console.log('\t -s, --save \t save presets');
      console.log('\t --long \t pass longitude (requires --lat)');
      console.log('\t --lat \t\t pass latitude (requires --long)');
      console.log('\t -c, --config \t use metric');
