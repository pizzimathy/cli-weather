...
Config.prototype.sudo = function () {
    ...
    if (this.args.s === true || this.args.save === true) {
...
Config.prototype.control = function () {
    ...
    } else if (args.c || args.a || args.address || args.z) {
...
function handleArgs(argv, units, ip) {
    ...
    if (argv.address || argv.a || argv.zip) {
        args.address(argv.address || argv.a || argv.zip, args.weatherRequest, units, argv);
